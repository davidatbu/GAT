...
class GraphAttentionLayer(nn.Module[torch.Tensor]):
    """
    ...
    def forward(self, input: torch.Tensor, adj: torch.Tensor) -> torch.Tensor:  # type: ignore
        ...
        attention = F.dropout(attention, self.dropout, training=self.training)  # type: ignore
